...
export default function HomeSection(){
  ...
  <div className="max-w-4xl text-center md:text-left relative">
    ...
    <div className="flex flex-col sm:flex-row gap-4 mt-5 w-full justify-center sm:justify-start">
      <a href="https://www.linkedin.com/in/mahnoor-shaikh/" className="inline-flex items-center justify-center w-full sm:w-48 h-16 bg-[#00ADB5] outline outline-2 outline-[#00ADB5] rounded-lg text-xl font-semibold text-white hover:bg-[#222831] transition-all">
        Connect Me
      </a>
  ...
  <a href="https://github.com/MAHNOORSHK" className="w-10 h-10 outline outline-2 outline-[#00ADB5] rounded-tl-xl rounded-br-xl text-2xl text-[#00ADB5] hover:text-white transition-all flex items-center justify-center">
    <i className="bx bxl-github"></i>
  </a>
  <a href="https://www.linkedin.com/in/mahnoor-shaikh/" className="w-10 h-10 outline outline-2 outline-[#00ADB5] rounded-tl-xl rounded-br-xl text-2xl text-[#00ADB5] hover:text-white transition-all flex items-center justify-center">
